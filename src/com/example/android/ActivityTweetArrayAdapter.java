 ...
 * @author Chirag Shah
 */
public class ActivityTweetArrayAdapter extends ArrayAdapter<Status> {
  public ActivityTweetArrayAdapter(Context context, List<Status> people) {
  ...
  public View getDropDownView(int position, View view, ViewGroup parent) {
    ...
    ((TextView) view.findViewById(R.id.twitter)).setText(status.getText());
